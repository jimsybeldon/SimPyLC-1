...
class Thing (Box):
    ...
    def __init__ (
        ...
        axis = (0, 0, 1),   # Initial attitude of the axis of initial rotation around the center
...
class Tetrahedron (Thing):
    def _draw (self):
        glRotate (-90, 0, 0, 1)
        glRotate (-90, 0, 1, 0)
        glScale (tetrahedronScale, tetrahedronScale, tetrahedronScale)
